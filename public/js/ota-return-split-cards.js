...
(function (global) {
    ...
    var config = { airlineLogoCdnTemplate: '', airlineLogoFallbackUrl: '/images/airline-generic.svg' };
    ...
    function init(options) {
        ...
        config.airlineLogoFallbackUrl = String(options.airlineLogoFallbackUrl || '/images/airline-generic.svg');
    }
    ...
    function airlineLogoUrlForCode(code, offer) {
        if (offer && offer.airline_logo_url) {
            return offer.airline_logo_url;
        }
        if (config.airlineLogoFallbackUrl) {
            return config.airlineLogoFallbackUrl;
        }
