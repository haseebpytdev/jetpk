...
export default defineConfig({
  testDir: path.join(process.cwd(), 'tests/playwright/jetpk-9h-c'),
  outputDir: path.join(process.cwd(), 'tests/playwright/artifacts/jetpk-9h-c/results'),
  globalSetup: path.join(process.cwd(), 'tests/playwright/jetpk-9h-c/global-setup.ts'),
  timeout: 120_000,
