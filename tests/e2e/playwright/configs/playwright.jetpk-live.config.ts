...
export default defineConfig({
  ...
  outputDir: path.join(process.cwd(), 'storage/app/audits/jetpk-playwright-live/traces'),
  globalTeardown: path.join(process.cwd(), 'tests/playwright/jetpk/global-teardown.ts'),
  use: {
