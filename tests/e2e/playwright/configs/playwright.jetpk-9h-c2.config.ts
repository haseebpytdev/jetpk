...
export default defineConfig({
  testDir: path.join(process.cwd(), 'tests/playwright/jetpk-9h-c2'),
  outputDir: path.join(process.cwd(), 'tests/playwright/artifacts/jetpk-9h-c2/results'),
  globalSetup: path.join(process.cwd(), 'tests/playwright/jetpk-9h-c2/global-setup.ts'),
  globalTeardown: path.join(process.cwd(), 'tests/playwright/jetpk-9h-c2/global-teardown.ts'),
  timeout: 180_000,
