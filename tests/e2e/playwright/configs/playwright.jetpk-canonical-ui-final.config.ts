...
export default defineConfig({
  ...
  outputDir: path.join(process.cwd(), 'test-results/jetpk-canonical-ui-final/traces'),
  globalSetup: path.join(process.cwd(), 'tests/visual/jetpk-canonical-ui-final.setup.ts'),
  use: {
