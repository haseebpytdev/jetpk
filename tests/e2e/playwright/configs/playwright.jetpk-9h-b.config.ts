...
export default defineConfig({
  ...
  outputDir: path.join(process.cwd(), 'tests/playwright/artifacts/jetpk-9h-b/results'),
  globalSetup: path.join(process.cwd(), 'tests/playwright/jetpk-9h-b/global-setup.ts'),
  timeout: 120_000,
