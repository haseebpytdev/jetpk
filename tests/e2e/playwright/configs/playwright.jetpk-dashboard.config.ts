...
export default defineConfig({
  testDir: path.join(process.cwd(), 'tests/playwright/jetpk-dashboard'),
  outputDir: path.join(process.cwd(), 'tests/playwright/artifacts/jetpk-dashboard/results'),
  globalSetup: path.join(process.cwd(), 'tests/playwright/jetpk-dashboard/global-setup.ts'),
  timeout: 120_000,
