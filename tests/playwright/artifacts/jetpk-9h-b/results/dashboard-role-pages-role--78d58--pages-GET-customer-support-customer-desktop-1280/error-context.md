...
- Name: dashboard-role-pages.spec.ts >> role-customer dashboard pages >> GET /customer/support
- Location: tests\playwright\jetpk-9h-b\dashboard-role-pages.spec.ts:25:7

# Error details

```
Error: Broken images on /customer/support: http://jetpk.test/storage/agencies/1/branding/jetpk-qa-9hb.png
```
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e9]:
    ...
    - main [ref=e40]:
      - generic [ref=e41]:
        - generic [ref=e42]:
          - heading "Support tickets" [level=1] [ref=e43]
          - paragraph [ref=e44]: Track questions, requests, and booking support.
        - link "Create support ticket" [ref=e46] [cursor=pointer]:
          - /url: http://127.0.0.1:8765/customer/support/tickets/create
      - generic [ref=e49]:
        - paragraph [ref=e50]: No support tickets yet
        - paragraph [ref=e51]: Create a ticket if you need help with a booking, payment, or document.
        - link "Create support ticket" [ref=e53] [cursor=pointer]:
          - /url: http://127.0.0.1:8765/customer/support/tickets/create
```
