...
- Name: dashboard-smoke.spec.ts >> JetPK dashboard smoke (unauthenticated safe routes) >> home and login render without console errors
- Location: tests\playwright\jetpk-9h\dashboard-smoke.spec.ts:14:3
