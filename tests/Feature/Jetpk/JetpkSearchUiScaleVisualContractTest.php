...
class JetpkSearchUiScaleVisualContractTest extends TestCase
{
    ...
    public function test_homepage_css_declares_scaled_outer_box_and_field_height_tokens(): void
    {
        ...
        $this->assertStringContainsString('.jp-home #jp-flight-search.search', $theme);
