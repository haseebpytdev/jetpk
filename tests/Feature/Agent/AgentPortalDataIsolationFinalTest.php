...
/**
 * Final cross-agent data isolation UAT for Agent A vs Agent B.
 */
class AgentPortalDataIsolationFinalTest extends TestCase
{
    use BuildsAgentPortalScenario;
    use RefreshDatabase;

    public function test_agent_a_admin_cannot_view_agent_b_booking_on_index_or_show(): void
    {
        ...
        $this->actingAs($scenario['adminA'])
            ->get(route('agent.bookings.show', $bookingB))
            ->assertForbidden();
    }
    ...
    public function test_agent_a_users_cannot_see_agent_b_wallet_balance(): void
    {
        $scenario = $this->buildAgentPortalScenario();
    ...
    public function test_agent_a_users_cannot_see_agent_b_deposits(): void
    {
        $scenario = $this->buildAgentPortalScenario();
    ...
    public function test_agent_a_users_cannot_see_or_edit_agent_b_travelers(): void
    {
        $scenario = $this->buildAgentPortalScenario();
    ...
    public function test_owner_agent_resolver_uses_agent_a_for_staff(): void
    {
        ...
        $this->assertNull($staff->fresh()->agentProfile);
    }
}
