...
class SabreCreatePayloadSafeSummaryTest extends TestCase
{
    ...
    public function test_summarize_create_payload_includes_two_segments_without_raw_request_or_response(): void
    {
        ...
        $this->assertFalse($summary['create_segment_linkage_present']);
        $this->assertFalse($summary['create_marriage_group_present']);
        ...
        $this->assertTrue($summary['create_halt_on_status_nn_omitted']);
        $this->assertSame(SabreCpnrOperationalAllowNnPolicy::POLICY_CERT_OPERATIONAL_OMIT_NN_WN, $summary['create_halt_on_status_policy']);
