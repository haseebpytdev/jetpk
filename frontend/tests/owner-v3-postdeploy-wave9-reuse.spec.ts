/**
 * Wave-9 visual matrix â€” Review / Payment genuine mock screenshots.
 * Writes to ../tmp/owner-v3-postdeploy-remediation/
 */
...
function reviewContext(opts: {
    ...
    ? [
        {
          ...
          passport_number_masked: "â€¢â€¢â€¢â€¢8776",
        ...
        },
        {
          ...
          nationality: "PK",
          document_type: "passport",
          passport_number_masked: "â€¢â€¢â€¢â€¢1122",
          passport_issuing_country: "PK",
  ...
  return {
    ...
    itinerary: {
      trip_type: "one_way",
      route_label: connected ? "ISB â†’ AUH â†’ DXB" : "ISB â†’ DXB",
      origin: "ISB",
      destination: "DXB",
...
test.describe("Wave-9 Review visual matrix", () => {
  ...
  test("capture review and payment screenshots", async ({ page }) => {
    ...
    await page.getByText("â€¢â€¢â€¢â€¢8776").first().scrollIntoViewIfNeeded();
