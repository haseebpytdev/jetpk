...
/**
 * Canonical public 404 entry for Laravel HTML error redirects.
 * Must return a successful Next document so OLS does not fall back to Laravel.
 */
export default async function PageNotFoundRoute() {
