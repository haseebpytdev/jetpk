        ...
        <div className="mt-jp-lg grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {items.map((offer, index) => (
            <ScrollReveal key={offer.id} as="article" staggerIndex={index + 1}>
              <article className="flex min-h-[12rem] flex-col justify-between rounded-jp-card border border-jp-border bg-gradient-to-br from-jp-primary to-jp-primary-hover p-jp-lg text-white shadow-jp-card">
                <div>
