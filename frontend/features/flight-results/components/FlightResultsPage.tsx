...
export function FlightResultsPage({
  ...
  return (
    <div className="w-full">
      ...
      <div className="jp-fab-content-clear mx-auto w-full max-w-7xl space-y-2.5 px-4 pb-24 pt-2.5 sm:px-6 sm:pb-10 lg:px-8 xl:pb-6">
        {editOpen ? (
          <div data-testid="inline-edit-search">
            <SearchModule layout="compact" showServiceSwitcher={false} />
          </div>
        ) : null}
