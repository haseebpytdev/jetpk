...
import type { ContentCard, LaravelManagedPageResponse, PublicPage, PublicPageHero, PublicSeo } from "../types";
...
export function resolveAboutPage(remote: LaravelManagedPageResponse | null): PublicPage {
...
export async function loadAboutPageBrowser(): Promise<PublicPage> {
  return resolveAboutPage(await fetchManagedPageBrowser("about"));
}
