...
@section('content')
    ...
    @include('emails.themes.jetpakistan.partials.alert-box', [
        ...
        'message' => 'We\'re reviewing your refund request. You\'ll get an update once it\'s processed.',
    ])
        ...
        <tr>
            <td style="padding:16px 18px;">
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                    ...
                    @include('emails.themes.jetpakistan.partials.info-row', ['label' => 'Status', 'value' => $p['status'] ?? 'Requested', 'emailBrand' => $brand])
                </table>
            </td>
        </tr>
    </table>
