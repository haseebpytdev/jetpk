...
<style>
    @media (max-width: 767.98px) {
        .staff-support-tickets-table .table thead th:nth-child(4),
        .staff-support-tickets-table .table thead th:nth-child(5),
        .staff-support-tickets-table .table thead th:nth-child(7),
        .staff-support-tickets-table .table tbody td:nth-child(4),
        .staff-support-tickets-table .table tbody td:nth-child(5),
        .staff-support-tickets-table .table tbody td:nth-child(7) {
            display: none;
        }
        .staff-support-tickets-table .table thead th:last-child,
        .staff-support-tickets-table .table tbody td:last-child {
            position: sticky;
            right: 0;
            z-index: 1;
...
@endsection
@section('content')
    <div class="card border-0 shadow-sm staff-support-tickets-table ota-admin-table">
        <div class="table-responsive ota-r-table-wrap">
            <table class="table card-table table-vcenter mb-0 ota-r-text-safe ota-admin-table" data-testid="staff-support-tickets-table">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="ota-r-table-actions justify-content-end ota-admin-action-group">
                                <a href="{{ route('staff.support.tickets.show', $ticket) }}" class="btn btn-sm btn-outline-primary">View</a>
                            </div>
                        </td>
                    </tr>
                @empty
