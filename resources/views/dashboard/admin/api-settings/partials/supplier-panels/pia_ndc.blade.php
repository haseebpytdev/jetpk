<div class="jp-provider-panel {{ $isPiaNdc ? '' : 'jp-is-hidden' }}" data-provider-panel="pia_ndc">
    <div class="jp-form-grid jp-form-grid--2">
        <div class="jp-field">
            <label class="form-label" for="pia-ndc-environment">Environment</label>
            <select id="pia-ndc-environment" name="environment" class="form-select" required data-pia-ndc-environment @disabled(! $isPiaNdc)>
