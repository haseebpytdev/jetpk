...
<div class="jp-provider-panel {{ $isGeneric ? '' : 'jp-is-hidden' }}" data-provider-panel="generic">
    <div class="jp-form-grid jp-form-grid--2">
        <div class="jp-field">
            <label class="form-label" for="generic-environment">Environment</label>
            <select id="generic-environment" name="environment" class="form-select" required @disabled(! $isGeneric)>
        ...
        <div class="jp-field jp-field--full">
            <label class="form-label" for="generic-base-url">Base URL</label>
            <input id="generic-base-url" type="url" name="base_url" class="form-control" value="{{ old('base_url', $connection->base_url) }}" placeholder="https://api.example.com" @disabled(! $isGeneric)>
