        ...
        <div class="jp-portal-table-wrap">
            <table class="jp-portal-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="7">@include('themes.frontend.jetpakistan.components.portal.empty-state', ['title' => 'No bookings found', 'message' => 'Try another filter or search for new flights.', 'actionUrl' => client_route('flights.search'), 'actionLabel' => 'Search flights'])</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
