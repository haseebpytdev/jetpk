...
export function TicketsFilters({ query, facets }: Props) {
  ...
  const moreActive =
    ...
    (query.refundEligibility !== "all" ? 1 : 0) +
    (query.voidStatus !== "all" ? 1 : 0) +
    (query.hasAgent !== "all" ? 1 : 0) +
    (query.travelFrom ? 1 : 0) +
    (query.travelTo ? 1 : 0) +
    (query.issueFrom ? 1 : 0) +
    (query.issueTo ? 1 : 0);

  return (
    <div className="space-y-3 rounded-2xl border border-jp-border bg-white p-3 shadow-sm" data-testid="tickets-filters">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end">
        ...
        <div className="flex flex-wrap gap-2">
          <Button
            ...
            data-testid="tickets-more-filters"
          >
      ...
      {moreOpen ? (
        <div
          ...
          data-testid="tickets-more-filters-panel"
        >
          <div>
