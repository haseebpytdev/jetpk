...
const relativeFiles = [
  ...
  "app/Http/Resources/Dashboard/DashboardReportResource.php",
  "app/Console/Commands/JetpkDash03HistoricalCurrencyConflictsCommand.php",
  "dashboard/features/bookings/booking-operational-actions.tsx",
