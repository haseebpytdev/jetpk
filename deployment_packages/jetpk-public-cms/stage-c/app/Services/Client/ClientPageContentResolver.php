...
final class ClientPageContentResolver
{
     ...
     *
     * - absent key ΓåÆ default
     * - present empty string (allowEmpty) ΓåÆ empty string (intentionally hidden)
     * - present null (nullable) ΓåÆ null
     * - non-empty ΓåÆ saved value
     * - boolean false ΓåÆ false
     * - present empty array ΓåÆ []
     *
