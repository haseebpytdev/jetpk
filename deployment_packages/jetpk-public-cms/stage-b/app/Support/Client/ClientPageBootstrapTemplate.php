 ...
 *
 * Used only by explicit import commands ΓÇö never as public runtime fallback.
 */
final class ClientPageBootstrapTemplate
{
    ...
    public static function footerContent(): array
    {
        return [
            ...
            'legal' => [
                ...
                'company_line' => 'JetPakistan ΓÇö IATA accredited travel services.',
            ],
    ...
    public static function aboutContent(): array
    {
        return [
            ...
            'seo' => [
                'title' => 'About us ΓÇö JetPakistan',
    ...
    public static function supportContent(): array
    {
        return [
            ...
            'form' => [
                ...
                'success_copy' => 'Thank you ΓÇö our team will respond shortly.',
            ],
            'faq_teaser' => [
                'enabled' => '1',
                'title' => 'FAQ',
            ...
            'seo' => [
                'title' => 'Support & contact ΓÇö JetPakistan',
    ...
    public static function faqContent(): array
    {
        return [
            ...
            'seo' => [
                'title' => 'FAQ ΓÇö JetPakistan',
                'description' => 'JetPakistan help centre ΓÇö booking, payments, and trip management FAQs.',
                'robots' => 'index,follow',
            ],
        ];
    }
    ...
    public static function termsContent(): array
    {
        return [
            ...
            'seo' => [
                'title' => 'Terms of service ΓÇö JetPakistan',
    ...
    public static function privacyContent(): array
    {
        return [
            ...
            'seo' => [
                'title' => 'Privacy policy ΓÇö JetPakistan',
    ...
    public static function loginContent(): array
    {
        return [
            ...
            'seo' => ['title' => 'Log in ΓÇö JetPakistan', 'description' => 'Sign in to your JetPakistan account.', 'robots' => 'noindex,nofollow'],
        ];
    }
    ...
    public static function registerContent(): array
    {
        return [
            ...
            'seo' => ['title' => 'Register ΓÇö JetPakistan', 'description' => 'Create your JetPakistan customer account.', 'robots' => 'noindex,nofollow'],
        ];
    }
    ...
    public static function bookingLookupContent(): array
    {
        return [
            ...
            'instructions' => [
                ...
                'requirements' => "Booking reference ΓÇö from your confirmation\nEmail address ΓÇö must match what we have on file",
            ],
            ...
            'seo' => ['title' => 'Lookup your booking ΓÇö JetPakistan', 'description' => 'Securely look up your JetPakistan booking.', 'robots' => 'noindex,nofollow'],
        ];
    }
        ...
        return [
            ...
            'faq' => [
                'items' => [
                    ...
                    ['id' => 'agent-faq-2', 'question' => 'Is approval instant?', 'answer' => 'No ΓÇö every application is reviewed before access is granted.', 'enabled' => '1', 'sort_order' => 1],
                ],
            ],
            'cta' => [
            ...
            'seo' => ['title' => 'Agent partnership ΓÇö JetPakistan', 'description' => 'Apply to join the JetPakistan agent network.', 'robots' => 'index,follow'],
        ];
    }
    ...
    public static function groupSearchContent(): array
    {
        return [
            ...
            'seo' => ['title' => 'Group travel search ΓÇö JetPakistan', 'description' => 'Search JetPakistan group and series inventory.', 'robots' => 'index,follow'],
        ];
    }
