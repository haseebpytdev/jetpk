...
return [
    'hero' => \App\Support\Client\Homepage\JetpkHomepageHeroSizing::defaultHeroSizingFields([
        ...
        'subtitle' => 'Compare 400+ airlines, pay in rupees, and get your e-ticket in seconds. The price you see is the price you pay ΓÇö no surprises at checkout.',
        'search_visible' => '1',
    ]),
    'trust_chips' => [
    ...
    'why_book' => [
        ...
        'cards' => [
            ['num' => '01 ┬╖ Pricing', 'title' => 'True PKR pricing', 'text' => 'Fares converted and locked in rupees ΓÇö no FX shock between search and payment.'],
    ...
    'support_cta' => [
        ...
        'subtitle' => 'Our Pakistan-based travel desk handles changes, refunds and group quotes ΓÇö 24 hours a day, in Urdu or English.',
    ...
    'group_cards' => [
        ...
        'subtitle' => 'Charter blocks, hajj/umrah groups, and corporate series ΓÇö managed inventory with manual approval.',
    ...
    'featured_deals' => [
        ...
        'subtitle' => 'Hand-picked sample fares for inspiration ΓÇö prices shown are editorial examples, not live quotes.',
        'cta_text' => '',
        'cta_url' => '',
        'card_count' => 3,
        'items' => [
