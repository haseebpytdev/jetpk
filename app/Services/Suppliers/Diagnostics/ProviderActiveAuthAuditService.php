...
final class ProviderActiveAuthAuditService
{
    ...
    public function auditAlHaider(bool $send = false): array
    {
        ...
        $result = [
            ...
            'token_cache_ttl_seconds' => max(60, (int) config('suppliers.al_haider.token_cache_ttl_seconds', 3600)),
            'token_performance_cache_max_seconds' => max(60, (int) config('suppliers.al_haider.token_performance_cache_max_seconds', 3600)),
            'token_validity_seconds' => max(3600, (int) config('suppliers.al_haider.token_validity_seconds', 31_536_000)),
            'token_expiry_margin_seconds' => max(60, (int) config('suppliers.al_haider.token_expiry_margin_seconds', 86_400)),
            'token_generation_enabled' => $this->alHaiderClient->isTokenGenerationEnabled(),
            'durable_token_present' => $this->alHaiderClient->hasPersistedToken(),
