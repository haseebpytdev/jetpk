 ...
 *
 * Deep-links to canonical /flights/results and /groups/{id} paths.
 * Short share-link generation is intentionally omitted so Ask does not
 * depend on the unmerged PublicShareLink stack.
 */
