    ...
    protected static function profileForEvent(string $eventKey, ?string $typeKey = null): array
    {
        ...
        $eventProfile = match ($eventKey) {
            'ticket_issued' => [
                ...
                'intro' => 'Your e-tickets are confirmed. Flight and passenger details are below.',
                'status_label' => 'Ticketed',
                'status_type' => 'success',
                'detail_fields' => ['booking_reference', 'pnr', 'ticket_numbers', 'tickets_count', 'route', 'passenger_name', 'booking_status'],
                'cta_label' => 'View booking',
                'cta_url_key' => 'manage_booking_url',
                'content_blocks' => ['status-alert', 'detail-fields', 'booking-summary', 'itinerary', 'passengers'],
        ...
        return match ($typeKey) {
            ...
            'booking_confirmed' => [
                ...
                'intro' => 'This booking is confirmed. Itinerary and passenger details are below.',
