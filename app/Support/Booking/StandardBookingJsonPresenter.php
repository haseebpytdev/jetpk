...
class StandardBookingJsonPresenter
{
    ...
    private function presentItinerary(array $viewData, ?array $offer, array $criteria): array
    {
        ...
        return [
            ...
            'authoritative_after_revalidation' => $authoritativeAfterRevalidation,
            'bound_search_id' => trim((string) ($draft['search_id'] ?? '')),
            'bound_offer_id' => trim((string) ($viewData['flightId'] ?? $draft['offer_id'] ?? $draft['flight_id'] ?? '')),
