...
class GroupTicketingJsonPresenter
{
    ...
    private function normalizeCard(array $card, ?GroupInventory $inventory = null): array
    {
        ...
        return [
            ...
            'origin_label' => $card['origin_label'] ?? null,
            'dest_label' => $card['dest_label'] ?? null,
            ...
            'meal_label' => $card['meal_label'] ?? 'Meal info not provided',
            'meal_status' => $card['meal_status'] ?? 'unspecified',
            'trip_type' => $card['trip_type'] ?? 'unspecified',
            'trip_type_label' => $card['trip_type_label'] ?? 'Itinerary type TBA',
