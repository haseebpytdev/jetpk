    ...
    public static function fields(): array
    {
        return [
            'hero' => [
                ...
                self::field('hero.cta_primary_text', 'Primary CTA text', 'string', default: 'Search flights', note: 'Task 9: hero.blade.php now renders both CTA buttons after the subtitle, before the search widget.'),
                self::field('hero.cta_primary_url', 'Primary CTA URL', 'url', default: '/flights'),
                self::field('hero.cta_secondary_text', 'Secondary CTA text', 'string', default: 'Group fares'),
                self::field('hero.cta_secondary_url', 'Secondary CTA URL', 'url', default: '/group-ticketing'),
