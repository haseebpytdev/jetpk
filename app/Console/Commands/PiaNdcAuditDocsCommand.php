...
class PiaNdcAuditDocsCommand extends Command
{
    protected $signature = 'pia-ndc:audit-docs';

    protected $description = 'Print PIA NDC 20.1 service matrix from integration reference concepts';
