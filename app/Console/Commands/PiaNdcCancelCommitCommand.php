...
class PiaNdcCancelCommitCommand extends Command
{
    protected $signature = 'pia-ndc:cancel-commit
        {booking : OTA booking ID}
        {--connection= : Supplier connection ID}';

    protected $description = 'Run PIA NDC DoOrderCancelCommit for an OTA booking';
