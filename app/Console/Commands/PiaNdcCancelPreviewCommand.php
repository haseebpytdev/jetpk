...
class PiaNdcCancelPreviewCommand extends Command
{
    protected $signature = 'pia-ndc:cancel-preview
        {booking : OTA booking ID}
        {--connection= : Supplier connection ID}';

    protected $description = 'Run PIA NDC DoOrderCancelPreview for an OTA booking';
