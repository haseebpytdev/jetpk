...
class AiAssistantStatusController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        $hardPublic = (bool) config('ota.ai_assistant.hard_allow.public', false);
        if ($hardPublic && $request->boolean('public_enabled')) {
            $payload['audience_mode'] = 'public';
            $payload['internal_canary_enabled'] = false;
        } else {
