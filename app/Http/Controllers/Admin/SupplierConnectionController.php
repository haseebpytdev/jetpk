...
class SupplierConnectionController extends Controller
{
    ...
    private function providerCards(array $configuredProviders): array
    {
        $catalog = [
            ...
            ['key' => 'pia_ndc', 'label' => 'PIA NDC / Hitit', 'channel' => 'Hitit Crane NDC 20.1', 'module' => 'flights', 'description' => 'Pakistan International Airlines direct NDC integration via Hitit Crane 20.1.', 'icon' => 'PK', 'capabilities' => ['NDC', 'Direct'], 'readiness' => 'Live ready'],
            ['key' => 'airblue', 'label' => 'AirBlue / Zapways', 'channel' => 'Zapways API / NDC', 'module' => 'flights', 'description' => 'AirBlue direct supplier integration via Zapways.', 'icon' => 'AB', 'capabilities' => ['OTA', 'NDC'], 'readiness' => 'Sandbox'],
