...
class SupplierConnectionController extends Controller
{
    ...
    private function providerCards(array $configuredProviders): array
    {
        $catalog = [
            ...
            ['key' => 'pia_ndc', 'label' => 'PIA NDC / Hitit', 'channel' => 'NDC', 'module' => 'flights', 'description' => 'Pakistan International Airlines NDC direct connect (Hitit Crane 20.1).', 'icon' => 'PK', 'capabilities' => ['NDC', 'Direct'], 'readiness' => 'Live ready'],
            ['key' => 'airblue', 'label' => 'AirBlue', 'channel' => 'Crane NDC / Zapways OTA', 'module' => 'flights', 'description' => 'AirBlue inventory via Crane NDC or Zapways OTA channel (select at connection setup).', 'icon' => 'AB', 'capabilities' => ['NDC', 'OTA'], 'readiness' => 'Sandbox'],
            ...
            ['key' => 'one_api', 'label' => 'One API (FlyJinnah / Air Arabia)', 'channel' => 'REST / SOAP', 'module' => 'flights', 'description' => 'Accelaero One API for FlyJinnah and Air Arabia content (live gates disabled by default).', 'icon' => '1A', 'capabilities' => ['Search', 'Book'], 'readiness' => 'Pending activation'],
            ...
            ['key' => 'airsial', 'label' => 'AirSial', 'channel' => 'Direct', 'module' => 'flights', 'description' => 'AirSial direct integration — adapter pending; use Airline Direct for custom carrier wiring.', 'icon' => 'PF', 'capabilities' => ['Direct'], 'readiness' => 'Planned'],
