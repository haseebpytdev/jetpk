...
| CMS Pages | Admin/Staff | `/cms/pages` | CmsPageController + CmsPageContentSanitizer | pages JSON | create/edit/archive/preview-draft | cms | Present | None | Deployed BUILD `gVySYezQbX8a2wfDmjyBM` | CmsPageBuilderRoundtripTest + production draft pack | OPERATIONAL | Builder tags persist; hidden not public |
