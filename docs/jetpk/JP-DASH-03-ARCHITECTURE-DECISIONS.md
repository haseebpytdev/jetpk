...
| AD-010 | Legacy Admin/Staff Blade shells redirect to Next after parity | Retire presentation only; keep controllers/services; **no active Blade operator shell** | Delete Laravel admin routes | Broken bookmarks | Legacy retirement | **Adopted** — exhaustive redirect matrix rebuilt; production acceptance redirects PASS |
