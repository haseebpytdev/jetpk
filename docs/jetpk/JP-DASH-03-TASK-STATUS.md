...
| JP-BOOK-01 | Full booking management | yes | yes | partial | no | partial | no | IN_PROGRESS | Timeline/notes/comms/docs panels on /bookings/[id] | pending | — | Deploy pending | Wave 4 |
