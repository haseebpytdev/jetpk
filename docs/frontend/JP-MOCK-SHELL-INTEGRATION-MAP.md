...
| `app/page.js` (homepage sections) | `app/dev/jetpk-homepage-v2/page.tsx` | Static homepage composition review | Section order, search dock geometry, card grids | Fresh V2 implementation; no SearchModule; no CMS | Fixture prices/routes/actions | `jp-public-next-theme-03.visual.spec.ts` |
