...
```
RETURN_METRIC_EQUIVALENCE=PASS
RETURN_METRIC_EQUIVALENCE_DETAIL=YES_VIA_BROWSER_RENDER_MS
RETURN_POST_SUPPLIER_TO_USABLE_P95=645
RETURN_PAIR_GATE=PASS
POLL_TOTAL_IS_POST_SUPPLIER=NO
CERT_SHA=cbd7686feadd35773fd0b597117538b8b99b59fa
CERT_BUILD=kf8S-ybDOI8Vw8LzUye0H
```
...
Same-SHA evidence: `docs/evidence/jp-final-perf-cert-cbd7686f/03-return-pair/RESULTS.md`
